...
public class OpenTripPlannerRestApiPlannerResourceWrapper {
	...
	public Response doPost(@Context UriInfo uriinfo, Iterable<Node[]> input) throws UnsupportedOperationException, URISyntaxException, IOException {
		...
		OpenTripPlannerRestApiPlannerResourceWrapper app = new OpenTripPlannerRestApiPlannerResourceWrapper();
		...
		return Response.status(Response.Status.OK).entity(new GenericEntity<Iterable<Node[]>>(graph) { }).header("Location", uri.getBaseUri() + "opt/" + counter).build();
	}
	...
	public List<Node[]> getDirections(Iterable<Node[]> input)
		...
		// general concepts shared with google maps wrapper
		...
		// opentripplanner specific
		context.put("plan", "routes");
		context.put("from", "start_location");
		context.put("lon", "lng");
		context.put("to", "end_location");
		context.put("itineraries", "steps");
		context.put("legs", "steps");
		context.put("streetName", "http://example.org/streetName");
		context.put("absoluteDirection", "http://example.org/absoluteDirection");
		context.put("relativeDirection", "http://example.org/relativeDirection");
